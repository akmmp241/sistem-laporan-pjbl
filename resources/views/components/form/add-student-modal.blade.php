      ...
      <div class="px-6 py-6 lg:px-8">
        ...
        <form class="space-y-6" action="{{ route('admin.students') }}" method="POST">
          ...
          <div>
            ...
            <input type="text" name="class" placeholder="masukan kelas"
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                   required>
          </div>
          <div>
            ...
            <select name="dudi"
                    class="block py-2.5 px-0 overflow-y-scroll text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">

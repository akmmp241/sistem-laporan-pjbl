...
{{--<!-- ===== Preloader Start ===== -->--}}
{{--<include src="./template/dashboard/src/partials/preloader.html"></include>--}}
{{--<!-- ===== Preloader End ===== -->--}}

{{--<!-- ===== Page Wrapper Start ===== -->--}}
{{--<div class="flex h-screen items-center overflow-hidden">--}}
{{--  <!-- ===== Sidebar Start ===== -->--}}
{{--  <include src="./template/dashboard/src/partials/sidebar.html"></include>--}}
{{--  <!-- ===== Sidebar End ===== -->--}}

{{--  <!-- ===== Content Area Start ===== -->--}}
{{--  <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">--}}
{{--    <!-- ===== Header Start ===== -->--}}
{{--    <include src="./template/dashboard/src/partials/header.html"></include>--}}
{{--    <!-- ===== Header End ===== -->--}}
...
{{--                  Aplikasi Sistem Absensi dan Pelaporan PJBL SMK Negeri 8 Semarang--}}
{{--                </p>--}}
